 ...
 *
 * ★ 정년트랙/비정년트랙 모두 휴직 기간을 승진예정일에 가산
 *   - 육아휴직, 고용휴직, 질병휴직, 학위취득휴직 등 모든 휴직 포함
 *
 * ================================================================================================
 * 승진임용의 제한 (제15조의2, 2012.7.1 신설)
 * ================================================================================================
 *
 * 다음에 해당하는 경우 승진임용 불가:
 * 가. 징계처분, 직위해제 또는 휴직 중인 자
 * 나. 징계처분 집행 종료 후 일정 기간 미경과:
 *     - 정직: 18개월
 *     - 감봉: 12개월
 *     - 견책: 6개월
 *
...
class PromotionEngine {
    ...
    getPromotionEligibleDate(teacher) {
        ...
        if (leaveMonths > 0) {
            ...
            PROMOTION_DEBUG && console.log('✓ 휴직 기간 반영:', teacher['성명'], leaveMonths, '개월 →', DateUtils.formatDate(eligibleDate));
        }
